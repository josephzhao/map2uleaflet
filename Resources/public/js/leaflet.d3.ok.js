L.D3geoJSON = L.Class.extend({
  ...
  var w_scale = (bounds[1][0] - bounds[0][0]) / this._width;
  var h_scale = (bounds[1][1] - bounds[0][1]) / this._height;
  var z = .96 / Math.max(w_scale, h_scale);
  var x = (bounds[1][0] + bounds[0][0]) / 2;
  var y = (bounds[1][1] + bounds[0][1]) / 2 + (this._height / z / 6);
  return [x, y, z];
}
});