                        ...
                        if (varFeatureTypeStyle.Rule.Filter.And) {
                            ...
                            if (pNameExist === true) {
                                for (var k = 0; k < ps.length; k++)
                                {
                                    ...
                                    if ((properties[propertyName] !== undefined && properties[propertyName] !== null) && (varFeatureTypeStyle.Rule.Filter.PropertyIsBetween.LowerBoundary !== undefined) && (varFeatureTypeStyle.Rule.Filter.PropertyIsBetween.UpperBoundary === undefined) && parseFloat(properties[propertyName]) > parseFloat(varFeatureTypeStyle.Rule.Filter.PropertyIsBetween.LowerBoundary.Literal))
                                    {
                                        p = this.setFeatureStyle(p, varFeatureTypeStyle.Rule);
                                    }
                            ...
                            if (pNameExist === true) {
                                for (var k = 0; k < ps.length; k++)
                                {
                                    if (ps[k]) {
                                        var p = d3.select(ps[k]);
                                        var properties = p[0][0].__data__.properties;
                                        if ((properties[propertyName] !== undefined && properties[propertyName] !== null) && rule.Filter.PropertyIsEqualTo.Literal !== undefined && rule.Filter.PropertyIsEqualTo.Literal !== null && properties[propertyName].toLowerCase() === rule.Filter.PropertyIsEqualTo.Literal.toLowerCase()) {
